...
package com.example.android.codelabs.lifecycle.step6_solution;
...
public class SavedStateActivity extends AppCompatActivity {
    ...
    private com.example.android.codelabs.lifecycle.step6_solution.SavedStateViewModel mSavedStateViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSavedStateViewModel = new ViewModelProvider(this).get(com.example.android.codelabs.lifecycle.step6_solution.SavedStateViewModel.class);
